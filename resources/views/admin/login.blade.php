...
<div class= "main">
    ...
    <form action="{{route('admin.dashboard')}}" method="POST" class="form" id="form-2">
        {{csrf_field()}}
        ...
        <div class="form-submit"><a style="color: #fff; text-decoration: none;" href="signup.php">Đăng Ký</a></div>
    </form>
